...
namespace margelo::nitro::webrtc {
   ...
   */
  struct PermissionDescriptor final {
  public:
  ...
  public:
    friend bool operator==(const PermissionDescriptor& lhs, const PermissionDescriptor& rhs) = default;
  };
  ...
  struct JSIConverter<margelo::nitro::webrtc::PermissionDescriptor> final {
    static inline margelo::nitro::webrtc::PermissionDescriptor fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::webrtc::PermissionDescriptor(
        JSIConverter<margelo::nitro::webrtc::PermissionName>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "name")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::webrtc::PermissionDescriptor& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "name"), JSIConverter<margelo::nitro::webrtc::PermissionName>::toJSI(runtime, arg.name));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<margelo::nitro::webrtc::PermissionName>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "name")))) return false;
      return true;
    }
  };
