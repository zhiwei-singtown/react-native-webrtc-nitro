...
namespace margelo::nitro::webrtc {
  ...
  public:
    friend bool operator==(const Event& lhs, const Event& rhs) = default;
  };
  ...
  struct JSIConverter<margelo::nitro::webrtc::Event> final {
    static inline margelo::nitro::webrtc::Event fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::webrtc::Event(
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "NONE")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::webrtc::Event& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "NONE"), JSIConverter<double>::toJSI(runtime, arg.NONE));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "NONE")))) return false;
      return true;
    }
  };
