 ...
 */
public class HybridWebrtcViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridWebrtcView::class.java)) {
  ...
  private fun getHybridView(view: View): HybridWebrtcView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridWebrtcView
  }
}
